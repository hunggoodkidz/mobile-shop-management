package mobileshop.model.FrontEnd.FormChon;

import mobileshop.model.FrontEnd.FormHienThi.HienThiLoaiSanPham;
...
public class ChonLoaiSanPhamForm extends JFrame {
    ...
    public ChonLoaiSanPhamForm(JTextField _txTarget) {
        ...
        // ======= Buttons Panel ===========
        btnCancel.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_cancel_30px_1.png")));
        btnOK.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_ok_30px.png")));
