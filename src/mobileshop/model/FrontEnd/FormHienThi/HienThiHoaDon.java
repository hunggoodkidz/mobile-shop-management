...
import mobileshop.model.FrontEnd.FormQuanLy.QuanLyChiTietHoaDonForm;
...
public class HienThiHoaDon extends FormHienThi {
    ...
    public HienThiHoaDon() {
        ...
        btnDetails.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/show_property_30px.png")));
