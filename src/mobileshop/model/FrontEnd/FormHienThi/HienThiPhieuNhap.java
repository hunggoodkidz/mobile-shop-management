...
import mobileshop.model.FrontEnd.FormQuanLy.QuanLyChiTietPhieuNhapForm;
...
public class HienThiPhieuNhap extends FormHienThi {
    ...
    public HienThiPhieuNhap() {
        ...
        btnDetails.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_show_property_30px.png")));
