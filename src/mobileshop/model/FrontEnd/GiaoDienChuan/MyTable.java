...
class StyleTableJTable extends javax.swing.JTable {

    private java.awt.Color rowColors[] = new java.awt.Color[2];
    private boolean drawStripes = false;

    public StyleTableJTable() {
    }

    public StyleTableJTable(int numRows, int numColumns) {
        super(numRows, numColumns);
    }

    public StyleTableJTable(Object[][] rowData, Object[] columnNames) {
        super(rowData, columnNames);
    }

    public StyleTableJTable(javax.swing.table.TableModel dataModel) {
        super(dataModel);
    }
     ...
     */
    private void updateStyleTableColors() {
