...
import mobileshop.model.FrontEnd.FormHienThi.HienThiHoaDon;
import mobileshop.model.FrontEnd.FormThemSua.ThemSuaHoaDonForm;
...
public class QuanLyHoaDonForm extends JPanel {
    ...
    JButton btnPrintPDF = new JButton("In Hóa Đơn");
...
//        plBtn.add(btnSua);
        ...
        btnPrintPDF.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/bill_30px.png")));
