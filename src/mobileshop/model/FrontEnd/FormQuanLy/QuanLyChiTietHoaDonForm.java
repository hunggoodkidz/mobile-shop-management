...
import mobileshop.model.FrontEnd.FormHienThi.HienThiChiTietHoaDon;
import mobileshop.model.FrontEnd.FormThemSua.ThemSuaChiTietHoaDonForm;
...
public class QuanLyChiTietHoaDonForm extends JFrame {
    ...
    public QuanLyChiTietHoaDonForm(String _mahd) {
        ...
        btnXoa.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_delete_forever_30px_1.png")));
