...
import mobileshop.model.BackEnd.QuanLyKhuyenMai.KhuyenMai;
import mobileshop.model.BackEnd.QuanLyKhuyenMai.QuanLyKhuyenMaiBUS;
import mobileshop.model.BackEnd.QuanLyLoaiSanPham.QuanLyLoaiSanPhamBUS;
...
import mobileshop.model.FrontEnd.FormChon.ChonKhuyenMaiForm;
...
class PhieuNhapHang extends FormHang {
    ...
    public PhieuNhapHang(int _x, int _y, int _width, int _height) {
        ...
        btnNhapHang.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_us_dollar_30px.png")));
...
class HoaDonBanHang extends FormHang {
    ...
    public HoaDonBanHang(int _x, int _y, int _width, int _height) {
        ...
        btnHuy.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_cancel_30px_1.png")));
        btnThanhToan.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_us_dollar_30px.png")));
        ...
        if (masp != null) {
            ...
            for (SanPham sp : qlspBUS.getDssp()) {
                if (sp.getMaSP().equals(masp)) {
                    ...
                    ImageIcon img = new ImageIcon(getClass().getResource("/mobileshop/images/Product Images/" + sp.getFileNameHinhAnh()));
