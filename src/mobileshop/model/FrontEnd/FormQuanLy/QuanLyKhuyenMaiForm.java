...
import mobileshop.model.FrontEnd.FormHienThi.HienThiKhuyenMai;
import mobileshop.model.FrontEnd.FormThemSua.ThemSuaKhuyenMaiForm;
...
public class QuanLyKhuyenMaiForm extends JPanel {
    ...
    public QuanLyKhuyenMaiForm() {
        ...
        // buttons
        btnKetThuc.setIcon(new ImageIcon(this.getClass().getResource("/mobileshop/images/icons8_cancel_30px_1.png")));
