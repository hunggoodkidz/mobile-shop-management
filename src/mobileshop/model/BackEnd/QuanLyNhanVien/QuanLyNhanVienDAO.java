...
import mobileshop.model.BackEnd.DatabaseConnection.ConnectionDB;
...
public class QuanLyNhanVienDAO {
        ...
        try {
            ...
            if (r != null) {
                while (r.next()) {
                    ...
                    dsnv.add(new NhanVien(manv, tennv, ngaysinh, diachi,email, sdt,url, tt));
                }
            }
    ...
    public Boolean add(NhanVien nv) {
        qlnvConnection = new ConnectionDB();
        Boolean ok = qlnvConnection.sqlUpdate("INSERT INTO `nhanvien` (`MaNV`, `TenNV`, `NgaySinh`, `DiaChi`, `Email`, `SDT`, `HinhAnh`,`TrangThai`) VALUES ('"
                + nv.getMaNV() + "', '"
                + nv.getTenNV() + "', '" 
                + nv.getNgaySinh() + "', '" 
                + nv.getDiaChi() + "', '" 
    ...
    public Boolean update(String MaNV, String TenNV, LocalDate NgaySinh, String DiaChi,String Email, String SDT,String filename, int trangthai) {
        qlnvConnection = new ConnectionDB();
