...
public class QuanLyNhanVienBUS {
    ...
    public String[] getHeaders() {
        return new String[]{"Mã nhân viên", "Tên nhân viên", "Ngày sinh", "Địa chỉ","Email", "Số điện thoại", "Trạng thái"};
    }
        ...
        dsnv.forEach((nv) -> {
            if (type.equals("Tất cả")) {
                if (nv.getMaNV().toLowerCase().contains(value.toLowerCase())
                        ...
                        || nv.getEmail().toLowerCase().contains(value.toLowerCase())
                ...
                switch (type) {
                    ...
                    case "Địa chỉ":
                        ...
                        break;
                    case "Email":
                        if (nv.getEmail().toLowerCase().contains(value.toLowerCase())) {
                            result.add(nv);
                        }
                        break;
                    case "Số điện thoại":
    ...
    public Boolean add(String manv, String tennv, LocalDate ngaysinh, String diachi,String email, String sdt,String url, int trangthai) {
        NhanVien nv = new NhanVien(manv, tennv, ngaysinh, diachi,email, sdt,url, trangthai);
        return add(nv);
    }
    ...
    public Boolean update(String manv, String tennv, LocalDate ngaysinh, String diachi,String email, String sdt,String url, int trangthai) {
        Boolean ok = qlnvDAO.update(manv, tennv, ngaysinh, diachi,email, sdt,url, trangthai);
