 ...
 */
package mobileshop.model.BackEnd.WritePDF;
...
//            JOptionPane.showMessageDialog(null, "Khong goi duoc document !");
    ...
    public void writeHoaDon(String mahd) {
        ...
        try {
            ...
            Paragraph paraFollow = new Paragraph(new Phrase("Follow us on Facebook", fontData));
            paraFollow.setIndentationLeft(300);
            document.add(paraFollow);
            String myString = "https://www.facebook.com/hutechuniversity";
            ...
            qrcodeImage.setIndentationLeft(300);
