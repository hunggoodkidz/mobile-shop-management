...
import mobileshop.model.FrontEnd.FormQuanLy.QuanLyTaiKhoanForm;
...
public class AccountForm extends javax.swing.JPanel {
    ...
    public AccountForm() {
        ...
        initComponents();
        QuanLyTaiKhoanForm qlaccount = new QuanLyTaiKhoanForm();
        plContent.setLayout(new BorderLayout());
        plContent.add(qlaccount, BorderLayout.CENTER);
