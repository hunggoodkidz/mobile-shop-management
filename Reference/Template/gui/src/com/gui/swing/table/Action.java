...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new com.gui.swing.Button();
        cmdDelete = new com.gui.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gui/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gui/icon/delete.png"))); // NOI18N
    ...
    private com.gui.swing.Button cmdDelete;
    private com.gui.swing.Button cmdEdit;
