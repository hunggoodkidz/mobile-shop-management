...
import com.gui.swing.noticeboard.ModelNoticeBoard;
import com.gui.swing.table.EventAction;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile.jpg")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile1.jpg")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/gui/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private void initComponents() {
        ...
        card3 = new com.gui.component.Card();
        card4 = new com.gui.component.Card();
        jPanel1 = new javax.swing.JPanel();
        noticeBoard = new com.gui.swing.noticeboard.NoticeBoard();
        ...
        table1 = new com.gui.swing.table.Table();
    ...
    private com.gui.component.Card card3;
    private com.gui.component.Card card4;
    ...
    private com.gui.swing.noticeboard.NoticeBoard noticeBoard;
    private com.gui.swing.table.Table table1;
